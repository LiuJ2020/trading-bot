...
SEGMENTS = {
    'precrisis': {
        ...
        'start': '2006-01-01',
        'end': '2010-12-31',
        'description': 'Pre-crisis bull run, 2008 GFC, initial recovery.'
    },
    'bull': {
        'name': '2015-2019',
        'start': '2015-01-01',
        'end': '2019-12-31',
        'description': 'Slow-growth bull, low volatility, trade war, flash crashes.'
    },
    'covid': {
        'name': '2020-2023',
        'start': '2020-01-01',
        'end': '2023-12-31',
        'description': 'COVID crash, rebound, inflation, Fed tightening, tech crash, partial recovery.'
    },
    'qe': {
        'name': '2011-2014',
        'start': '2011-01-01',
        'end': '2014-12-31',
        'description': 'Post-crisis QE bull, Eurozone crisis.'
    },
    'expansion': {
        'name': '2003-2007',
        'start': '2003-01-01',
...
STOCK_GROUPS = {
    ...
    'ETF': [
        'SPY', 'IVV', 'VOO', 'VTI', 'QQQ', 'DIA', 'IWM', 'EFA', 'EEM', 'VNQ', 'LQD', 'BND', 'AGG', 'GLD', 'SLV', 'XLF', 'XLY', 'XLC', 'XLI', 'XLE', 'XLB', 'XLV', 'XLU', 'XBI'
    ],
    'DOW30': [
...
def get_sp500_tickers():
    """
    Returns the list of S&P 500 tickers, updating STOCK_GROUPS['SP500'] if needed.
    """
